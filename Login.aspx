...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPrincipal" Runat="Server">
                        ...
                        <table>
                            <tr>
                                <td align="center" colspan="2">
                                    <b>Cadastrar um nova conta</b></td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="ConfirmPasswordLabel" runat="server" 
                                        AssociatedControlID="ConfirmPassword">Confirmar Senha:</asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:CompareValidator ID="PasswordCompare" runat="server" 
                                        ...
                                        Display="Dynamic" 
                                        ErrorMessage="A Senha e a Confirmação de senha tem que ser as mesmas." 
    ...
    <div style="margin-left: 400px; margin-top:10px;">
        <asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" 
            ...
            FailureText="Falha no login. Tente novamente.">
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:CheckBox ID="RememberMe" runat="server" Text="Lembrar de mim." />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2" style="color:Red;">
                                ...
                                <tr>
                                    <td align="right" colspan="2">
                                        <asp:Button ID="LoginButton" runat="server" BackColor="#FFFBFF" 
                                            ...
                                            Font-Names="Verdana" Font-Size="0.8em" ForeColor="#284775" Text="Logar" 
