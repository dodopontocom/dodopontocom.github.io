						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
							   <div class="panel-body panel_text">
								Não se preocupe com nada e deixe tudo com a gente !! Garantimos otimizar a sua reforma prezando uma ótima qualidade e rapidez no serviço. Seja uma reforma pequena ou grande estamos preparados para melhor atendê -lo. Para mais detalhes ente em contato conosco.
							  </div>
							</div>
						  </div>
						</div>
