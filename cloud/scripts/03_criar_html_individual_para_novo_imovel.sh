				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1" id="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">CONTRUÇÃOspan class="caret"></span></a>
								<ul class="dropdown-menu">
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							  <div class="panel-body panel_text">
								A <b>Carvalho Pereira</b> conta com mais de 20 anos de experiência no segmento da construção civil, com o objetivo de melhor administrar a sua obra, investir seu dinheiro de uma forma precisa e segura, tudo com total transparência assim podendo garantir a satisfação dos nossos clientes.
							  </div>
							</div>
						  </div>
						  <div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
							   <div class="panel-body panel_text">
								Temos engenheiros preparados para um atendimento sem compromisso entre em contato conosco diretamente pelo Whatsapp ou ligue.							  </div>
							</div>
						  </div>
						  <div class="panel panel-default">
							...
							<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
							   <div class="panel-body panel_text">
								As suas ideias transformadas em projetos profissionais e consultoria diferenciada. Fazemos projetos para sua obra e muito mais. Entre em contato com Patrícia Carvalho pelo whatsapp.
							  </div>
							</div>
						  </div>
						  <div class="panel panel-default">
