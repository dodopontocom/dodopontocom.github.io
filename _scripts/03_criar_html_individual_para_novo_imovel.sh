...
<!-- -->
				...
				<div class="w3_single_grid_left">
					<div class="w3_single_grid_left_grid w3l_services_grid">
						...
						<!-- banner -->
							<div class="banner">
								<div id="kb" class="carousel kb_wrapper" data-ride="carousel" data-interval="5000" data-pause="hover">
						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
							   <div class="panel-body panel_text">
								Temos engenheiros disponíveis para uma conversa sem compromisso asodkpaok dpaoskd aoueha soheaoieja osijdas odjosid d oaisjd aoije aoij. oiaoaaoaoaoo jiosjd oaentre em contato.
							  </div>
							</div>
						  </div>
						  <div class="panel panel-default">
